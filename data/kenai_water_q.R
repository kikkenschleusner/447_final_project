...
date_nitrate_nitrate <- Nitrate_Nitrite$activity_start_date
measured_iron <- Nitrate_Nitrite$result_measure_value
iron_unit <- Nitrate_Nitrite$result_measure_measure_unit_code
